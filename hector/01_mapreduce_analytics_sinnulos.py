...
def interpretar_mapreduce(resumen_df):
    ...
    # Convertimos a Pandas SOLO para visualización
...
def main():
    ...
    # =====================================================
    # 🔄 RECLASIFICACIÓN DE DATOS NULOS
    # =====================================================
    # En lugar de eliminar registros con producto NULL,
    # los convertimos en "SIN_CLASIFICAR".
    #
    # Esto es mejor práctica porque:
    # - No perdemos información
    # - Permite análisis de calidad de datos
    # - Mantiene integridad estadística
    #
    ...
    # =====================================================
    # MAP → Spark calcula agregaciones parciales por partición
    # REDUCE → Combina resultados por clave (producto)
    #
